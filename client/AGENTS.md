...
- Keep isolated tests under the mirrored `tests/unit` tree, cross-workflow stateful tests under `tests/integration`, and reusable test fixtures under `tests/helpers`, all with explicit Vitest imports. Use Playwright for critical browser workflows.
