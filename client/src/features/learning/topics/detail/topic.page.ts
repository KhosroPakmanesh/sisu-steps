...
import { findModeSession, findTestSession } from '../../shared/progress/session.queries';
import { lessonProgressForTest } from '../../shared/progress/lesson-progress.queries';
...
import { getTopicSummary } from '../catalog/topic-catalog.queries';
