...
- The generated `client/public/content/` catalog and bundled pack, generic compiler, generator entry point, compiler declarations, and `content:generate` package command were removed. `client/public/` retains only the unrelated favicon.
