...
- `REQ-G005-001`–`REQ-G005-020`, `REQ-G005-022`, `REQ-G005-023`, and `REQ-G005-025`–`REQ-G005-036`; `REQ-G005-021` and `REQ-G005-024` are withdrawn.
...
- A phone-only compact vertical rhythm, transparent-backed in-flow primary-navigation row, centered catalog/topic/lesson hero annotations, compact two-column summary groups and right-aligned card status marks where space permits, and a safe-area-aware Study action dock that preserve content, typography, touch targets, document order, and the complete 48rem-and-wider layout.
