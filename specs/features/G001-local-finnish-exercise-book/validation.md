...
- **VAL-G001-077** (`REQ-G001-119`): State-alignment and backup tests seed version 6.1.0 attempts, unfinished ordinary and cumulative-Review sessions, mistakes, corrections, mastery, lesson completions, topic notes, and lesson notes. They verify ordinary records move by test, cumulative-Review records split by exercise owner, exercise records remain valid, the topic note moves to `kpt-singular-forms`, and unrelated packs remain unchanged.
