...
- Preserve the product invariant that core study, scoring, history, and progress statistics work without a service dependency unless the root product contract is explicitly amended.
